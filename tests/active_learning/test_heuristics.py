...
"""
import unittest
from active_learning.heuristics import (
...
class TestHeuristic(unittest.TestCase):
    ...
    def test_stratified_random_sample(self):
    ...
    def test_convert_to_sample_ranks(self):
    ...
    def test_ordered_indices_list_to_final_rank(self):
    ...
    def test_kl_divergence_sampling(self):
        """
